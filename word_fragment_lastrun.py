...
expName = 'word_fragment'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\admin\\Documents\\psychopy\\word_fragment_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/admin/Documents/psychopy/study_words.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/admin/Documents/psychopy/test.xlsx'),
